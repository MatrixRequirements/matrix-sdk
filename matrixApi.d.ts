declare module matrixApi
{
	...
	*/
	...
	class ConfigPageUsersBase extends ConfigPage {
	    ...
	    protected getAccessRights(groupId: number, project: string): "" | "Q" | "R" | "W";
	    protected getAccessLetterFromNumber(projectRights: number): "" | "Q" | "R" | "W";
	}
	...
	*/ 
	...
	class XTCStatus implements IPrintFunction {
	    ...
	    protected getStatus(result: string, mf: JQuery): "" | "new" | "warning" | "ok" | "error";
