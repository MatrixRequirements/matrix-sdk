...
export type GetItemConfigFunction = () => ItemConfiguration;
...
export type FunctionRenderHumanDate = (date: Date) => string;
export type FunctionSanitize = (data: string) => string;
